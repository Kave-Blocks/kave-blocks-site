...
const Featured2 = () => {
  return (
    <div className='min-h-screen flex justify-center items-center px-20 py-20'>
        ...
        <img src="/circleOnly.svg" alt="" className='absolute top-0 -right-12 z-0'/>

            <h2 className='text-[36px] text-start text-black mb-10 pl-20'>Lorem ipsum dolor<br/> sit amet adipiscing </h2>
