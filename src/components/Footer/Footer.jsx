...
const Footer = () => {
  return (
    <div className='flex justify-center items-center py-20 bg-black'>
        <div className="mx-auto max-w-7xl w-full flex flex-col tablet:flex-row">
            <div className="flex-[1] flex justify-center items-center mb-10 tablet:mb-0">
                <h2 className='text-2xl tablet:text-5xl text-white'>DIGITAL WEB3 AGENCY</h2>
            </div>
            <div className="flex-[1] flex justify-center items-center border-l-[1px] border-white px-10">
            ...
            <div className="flex-[1] flex justify-center items-center border-l-[1px] border-white ">
                <div className="flex flex-col gap-y-5 w-full px-10 tablet:px-0 mt-10">
                    <h3>CONTACT</h3>
